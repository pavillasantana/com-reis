  ...
  useEffect(() => {
    ...
    if (isBrazil) {
      ...
      const globalCoords: Record<string, [number, number]> = {
        ...
        'boston': [42.3601, -71.0589], 'washington': [38.9072, -77.0369], 'seattle': [47.6062, -122.3321],
        ...
        'dublin': [53.3498, -6.2603], 'lisbon': [38.7223, -9.1393], 'barcelona': [41.3874, 2.1686],
        'moscow': [55.7558, 37.6173], 'istanbul': [41.0082, 28.9784], 'tokyo': [35.6762, 139.6503],
        'osaka': [34.6937, 135.5023], 'beijing': [39.9042, 116.4074], 'shanghai': [31.2304, 121.4737],
        'hong kong': [22.3193, 114.1694], 'singapore': [1.3521, 103.8198], 'seoul': [37.5665, 126.9780],
        'taipei': [25.0330, 121.5654], 'bangkok': [13.7563, 100.5018], 'mumbai': [19.0760, 72.8777],
        'delhi': [28.7041, 77.1025], 'bangalore': [12.9716, 77.5946], 'dubai': [25.2048, 55.2708],
        'abu dhabi': [24.4539, 54.3773], 'riyadh': [24.7136, 46.6753], 'tel aviv': [32.0853, 34.7818],
        'cairo': [30.0444, 31.2357], 'cape town': [-33.9249, 18.4241], 'johannesburg': [-26.2041, 28.0473],
        'nairobi': [-1.2921, 36.8219], 'marrakech': [31.6295, -7.9811],
        'toronto': [43.6510, -79.3470], 'vancouver': [49.2827, -123.1207], 'montreal': [45.5017, -73.5673],
        'mexico city': [19.4326, -99.1332], 'buenos aires': [-34.6037, -58.3816], 'santiago': [-33.4489, -70.6693],
        'bogota': [4.7110, -74.0721], 'lima': [-12.0464, -77.0428], 'sao paulo': [-23.5505, -46.6333],
