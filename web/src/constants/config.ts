...
// ─── Supabase ──────────────────────────────────────────────────────────────
// NOTA: Usamos import.meta.env.* diretamente (sem alias) porque o Vite 8/Rolldown
// não consegue substituir variáveis de ambiente através de aliases de variável.
export const SUPABASE_URL = import.meta.env.EXPO_PUBLIC_SUPABASE_URL ?? '';
export const SUPABASE_ANON_KEY = import.meta.env.EXPO_PUBLIC_SUPABASE_ANON_KEY ?? '';
...
// export const MP_ACCESS_TOKEN = import.meta.env.MP_ACCESS_TOKEN ?? ''; // SERVER-ONLY — NÃO EXPOR
...
if (import.meta.env.DEV) {
  ...
  if (import.meta.env.EXPO_PUBLIC_MP_ACCESS_TOKEN) {
    console.warn(
