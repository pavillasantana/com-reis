...
export const parseCSV = (text: string): ParsedBankTransaction[] => {
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    const categoryRules: [string, string[]][] = [
      ['Investimentos', ['bovespa', 'b3', 'corretora', 'açao', 'acao', 'ações', 'investimento', 'fundo', 'etf', 'fiis', 'fiagro', 'renda fixa', 'cdb', 'lci', 'lca', 'tesouro', 'stock', 'broker', 'trading', 'bolsa', 'clear', 'xp investimentos', 'btg', 'itau ubs', 'bradesco asset', 'asset management', 'aplicacao', 'aplicação', 'resgate']],
      ['Proventos', ['dividendo', 'dividends', 'jcp', 'juros sobre capital', 'rendimento', 'provento', 'provents', 'fracao', 'fraction']],
